...
fn published_file_is_one_measured_interval_and_old_rows_project() -> TestResult {
    ...
    connection.execute_batch("DROP TABLE IF EXISTS monitor_steps; DROP TABLE IF EXISTS monitor_actions; DROP TABLE IF EXISTS monitor_versions; DROP TABLE IF EXISTS monitors; DROP TABLE IF EXISTS job_attempts; DROP TABLE IF EXISTS translation_cues; DROP TABLE IF EXISTS translations; DROP TABLE IF EXISTS translation_jobs; DROP TABLE IF EXISTS translation_profiles; DROP TABLE IF EXISTS provider_attempts; DROP TABLE IF EXISTS provider_price_snapshots; DROP TABLE IF EXISTS provider_route_pairs; DROP TABLE IF EXISTS provider_routes; DROP TABLE IF EXISTS recognition_profiles; DROP TRIGGER IF EXISTS analysis_read_lease_delete; DROP TRIGGER IF EXISTS analysis_read_lease_release; DROP TABLE IF EXISTS transcript_coverage; DROP TABLE IF EXISTS analysis_jobs; DROP TABLE IF EXISTS language_evidence; DROP TABLE IF EXISTS analysis_decisions; DROP TABLE IF EXISTS transcript_cues; DROP TABLE IF EXISTS transcripts; DROP TABLE IF EXISTS analysis_inputs; DROP TABLE IF EXISTS directory_refresh_policies; DROP TABLE IF EXISTS schedule_occurrences; DROP TABLE IF EXISTS schedule_rules; DROP TABLE IF EXISTS recording_releases; DROP TABLE IF EXISTS recording_hold_gaps; DROP TABLE IF EXISTS recording_hold_segments; DROP TABLE IF EXISTS recording_holds; DROP TABLE IF EXISTS recording_segment_clocks; DROP TABLE IF EXISTS recording_gaps; DROP TABLE recording_intervals; DROP INDEX IF EXISTS recording_open_object_keys; ALTER TABLE recordings DROP COLUMN lease_renewals; ALTER TABLE recordings DROP COLUMN lease_expires_ms; ALTER TABLE recordings DROP COLUMN open_object_key; ALTER TABLE recordings DROP COLUMN open_ceiling; ALTER TABLE recordings DROP COLUMN escrow_bytes; PRAGMA user_version = 15;")?;
    drop(connection);
