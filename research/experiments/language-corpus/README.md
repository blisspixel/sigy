...
The [pinned card acquisition](card-provenance-pilot.md) retained and hashed the revision's 385,614-byte card on 2026-09-23. Its official license text and subset attribution packet remain open gates before any audio GET. The card is provenance evidence, not a selected recording.
