...
The [Arabic](arabic-reference-pilot.md) and [Hindi](hindi-reference-pilot.md) calibration reference pilots each retain and validate one pinned train TSV and selected row for evaluator-only use. The separately [acquired Arabic audio](arabic-audio-pilot.md) has reached bounded decoding, not speech recognition. Spanish and holdout references remain unrequested; Hindi audio remains unrequested.
