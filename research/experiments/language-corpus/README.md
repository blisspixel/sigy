...
The [Arabic](arabic-reference-pilot.md) and [Hindi](hindi-reference-pilot.md) calibration reference pilots each retain and validate one pinned train TSV and selected row for evaluator-only use. The separately acquired [Arabic](arabic-audio-pilot.md) and [Hindi](hindi-audio-pilot.md) audio have reached bounded decoding, with no speech recognition result. Spanish and holdout references remain unrequested.
