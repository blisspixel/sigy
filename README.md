...
See [local podcast subscriptions](docs/decisions/0017-local-podcast-subscriptions.md) and [RSS feed refresh](docs/decisions/0018-rss-feed-refresh.md). Catalog schema is v13 and local IPC is v14. Stop an older service with its existing binary before updating, then restart it.
