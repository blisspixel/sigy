...
- `doctor` checks the library, decoder, quota, and cache age. It does not refresh, delete, or use the network. A stale station cache stays searchable. Favorites stay. The suggested refresh command is explicit.
