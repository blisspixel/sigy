...
| `sigy podcast` | Local subscribe, unsubscribe, one RSS 2.0 refresh, and offline episode listing are implemented. Enclosure download, bounded backfill, queued processing, and export remain later |
