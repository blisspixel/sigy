...
Priority update, 2026-09-22: podcast ingestion now belongs with internet radio before hardware. Operation 10 stores a local subscription and does not fetch the feed. Operation 11 refreshes one RSS 2.0 document and lists episodes. Enclosure download remains a later operation. The section anchor is retained for existing links; broader RSS/Atom text analysis remains later work.
