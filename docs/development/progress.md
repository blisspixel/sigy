...
- **Process containment:** Job Object limits on Windows; Linux cgroup path untested; macOS fails closed (`limits-unavailable`). Suspended-spawn assignment window remains.
