...
An unpublished recording is not playable. Transcript and chapter URLs are not fetched. Catalog schema stays v14. Local IPC stays v15. There is no migration. This does not exit stage 4. Publisher text remains a later operation.
