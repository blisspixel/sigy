...
The list explorer does not subscribe, refresh, or list episodes. No automatic poll runs. Enclosure download and playback are separate explicit operations. See [one episode enclosure](0019-episode-enclosure.md) and [retained episode playback](0020-retained-episode-playback.md). This does not exit stage 4.
