...
- Selected Ratatui 0.30.2 with the Termina 0.3.3 backend for the later list explorer. Crossterm 0.29.0 was rejected because Windows bracketed paste arrived as keys. The measurement ran on ConPTY and in Windows Terminal 1.24.11911.0. No terminal crate was added, and the client still opens no second catalog.
